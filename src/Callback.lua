...
if Text and Text:match('(%d+)/play_wheel') then
  ...
  keyboard.inline_keyboard = {
  {
  {text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗡𝗜𝗣𝗘𝗥',url="t.me/BPHEE"}, 
  },
  }
  local msg_reply = msg_id/2097152/0.5
...
{
{text = '{ اوامر التسلية }', data = IdUser..'/helpts'},{text = '{ اوامر الميوزك }', data = senderr..'/helptss'},
},
{
...
elseif Text and Text:match('(%d+)/helptss') then
local UserId = Text:match('(%d+)/helptss')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
⩹━⛥━𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗡𝗜𝗣𝗘𝗥━★━⩺
  ...
  ╭۪ᰲ╍ׂ╌ׂ╍۪ᰲ╌ᰲ┄ׅ╍╌ᰲ┄ׅ╍╌ᰲ┄ׅ╍╌ᰲ┄ׅׅ╍╌ᰲ┄ׅׅ╍╌ׅ╮
       🎧 :  اوامر تشغيل البوت في الجروب
  ╰۫᷼╍ׅ╌ׅ╍۫᷼╌᷼┄۫╍╌᷼┄۫╍╌᷼┄۫╍╌᷼┄۫╍╌ᰲ┄ׅׅ╍╌۫╯
...
⩹━⛥━𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗡𝗜𝗣𝗘𝗥━★━⩺
     ...
     ╭۪ᰲ╌ᰲ┄ׅ╍╌ᰲ┄ׅ╍╌ᰲ┄ׅ╍╌ᰲ┄ׅׅ╍╌ᰲ┄ׅׅ╍╌ᰲ╌ׅ╮
         🎧 :  اوامر تشغيل البوت في القناه      
     ╰۫᷼╌᷼┄۫╍╌᷼┄۫╍╌᷼┄۫╍╌᷼┄۫╍╌ᰲ┄ׅׅ╍╌᷼╌۫╯
